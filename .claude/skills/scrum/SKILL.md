...
- The target branch per the ticket (`fix/*` or `feature/*` cut from `main` — see the Branching Convention in `docs/guides/CONTRIBUTING.md`).
...
- Commits and pushes follow the session's git rules; PRs go directly into `main`.
